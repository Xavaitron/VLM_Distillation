...
## Screenshots
### 1. Teacher Evaluation (91.12%)
![Teacher Eval](image_path_here) *The teacher establishes a strong upper bound.*

### 2. Baseline Training (Max: 76.91%)
![Baseline Graph](image_path_here) *Without help, the tiny model struggles to generalize as well.*

### 3. Distillation Training (Max: 83.38%)
![Distillation Graph](image_path_here) *With the teacher's guidance, the student learns much faster and better.*
