...
if args.teacher == "LTD":
    ...
    state_dict = torch.load('./result_models/rslad_0_0_0_100_BDM2024-03-23RES-18.pt')
    teacher.load_state_dict(state_dict)
elif args.teacher == "SELF2":
    teacher = resnet18()
    teacher = torch.nn.DataParallel(teacher)
    state_dict = torch.load('./result_models/rslad_0_0_0_100_SELF2024-03-27RES-18.pt')
    teacher.load_state_dict(state_dict)
else:
    pass
...
model_name = f'rslad_{args.teacher}_{args.student}_{args.epochs}ep_{save_time}.pt'
